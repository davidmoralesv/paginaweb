...
function shrink() {
  document.getElementsByClassName('wrapper2')[0].setAttribute("style", "width:200px;height:200px;");
  tank.redraw();
}
function enlarge() {
  document.getElementsByClassName('wrapper2')[0].setAttribute("style", "width:400px;height:400px;");
  tank.redraw();
}
function high() {
